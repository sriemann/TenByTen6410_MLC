...
//        mfc_args.get_buf_addr.in_usr_data = pCTX->proc_id;
    ...
    case H264_DEC_GETCONF_STREAMINFO_CROP:

        // Get Infomation corp_left, corp_right
        mfc_args.get_config.in_config_param      = MFC_GET_CONFIG_DEC_H264_CROP_LEFT_RIGHT;
        mfc_args.get_config.out_config_value[0]  = 0;
        mfc_args.get_config.out_config_value[1]  = 0;
        r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_GET_CONFIG,
                            &mfc_args, sizeof(MFC_GET_CONFIG_ARG),
        ...
        // Get Infomation corp_top, corp_bottom
        mfc_args.get_config.in_config_param      = MFC_GET_CONFIG_DEC_H264_CROP_TOP_BOTTOM;
        mfc_args.get_config.out_config_value[0]  = 0;
        mfc_args.get_config.out_config_value[1]  = 0;
        r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_GET_CONFIG,
                            &mfc_args, sizeof(MFC_GET_CONFIG_ARG),
        ...
        // Output arguments
        ((unsigned int*) value)[2] = mfc_args.get_config.out_config_value[0];
        ((unsigned int*) value)[3] = mfc_args.get_config.out_config_value[1];
